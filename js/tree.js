...
function adjust_body_size() {
  ...
  document.body.style.width = treeWidth > bodyWidth ? treeWidth + "px" : "";
}

window.addEventListener("resize", adjust_body_size());
  ...
  fetchPeopleData().then((data) => {
    ...
    $("#expandAll").on("click", function () {
      if (!isExpanded) {
        ...
        $(this).text("Herkesi Gizle"); // Change button text
        ...
        $(".genealogy-tree ul")
          ...
          .hide("fast")
          .removeClass("active");
        $(this).text("Herkesi Göster"); // Change button text back
    ...
    $(".agree-button").on("click", closeModal)
